...
# from app_payments import payments_bp  # Temporarily disabled due to CSS syntax errors
...
# app.register_blueprint(payments_bp)     # Temporarily disabled due to CSS syntax errors
